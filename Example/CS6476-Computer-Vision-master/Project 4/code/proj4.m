...
%  CLASSIFIER = 'support vector machine extra';
...
switch lower(FEATURE)    
    ...
    case 'bag of sift'
        ...
        [train_image_feats,D] = get_bags_of_sifts(train_image_paths);
...
switch lower(CLASSIFIER)    
    ...
    case 'support vector machine extra'
        predicted_categories = svm_classify_extra(train_image_feats, train_labels, test_image_feats);
