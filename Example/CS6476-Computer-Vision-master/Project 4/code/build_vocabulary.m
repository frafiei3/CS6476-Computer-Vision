...
for i = 1:image_num
    ...
    random_permutation = randperm(size(SIFT_features,2));
    SIFT_sample = [SIFT_sample SIFT_features(:,random_permutation(1:20))];
end

SIFT_sample = single(SIFT_sample);
[vocab, assignments] = vl_kmeans(SIFT_sample, vocab_size);
